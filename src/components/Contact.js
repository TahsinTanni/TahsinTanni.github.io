    ...
    <div className="contact-container fade-in">
      ...
      <div className="contact-links">
        ...
        <a href="https://www.linkedin.com/in/tahsintanni/" target="_blank" rel="noopener noreferrer" className="contact-icon" title="LinkedIn">
          <svg width="28" height="28" fill="none" viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="5" stroke="#FFB6C1" strokeWidth="2"/><path d="M8 11v5M8 8v.01M12 11v5m0-5a2 2 0 1 1 4 0v5" stroke="#6C63FF" strokeWidth="2" strokeLinecap="round"/></svg>
        </a>
      </div>
    </div>
  );
